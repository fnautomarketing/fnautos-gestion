    ...
    const items = [
        {
            ...
            description: "Suma total de todas las facturas emitidas y pagadas. No incluye borradores ni facturas anuladas.",
        ...
        },
        {
            ...
            description: "Importe total de facturas emitidas que aún no han sido cobradas.",
        ...
        // (Se eliminó el item de vencidas)
        {
            id: 'mes',
            label: 'Este Mes',
            description: "Importe total facturado en el mes actual.",
            value: stats.esteMes,
            icon: Calendar,
                    ...
                    <CardContent className="p-6 relative z-10">
                        <div className="flex items-start justify-between mb-4">
                            <div className="space-y-1">
                                ...
                                <div className="text-2xl font-black text-slate-900 dark:text-white tracking-tighter">
                                    <AnimateNumber value={item.value} formatter={formatCurrency} />
                                </div>
                            </div>
                            <div className={cn(
                        ...
                        <div className="mt-2 h-1 overflow-hidden rounded-full bg-slate-100 dark:bg-slate-800/50">
                            <div 
                                ...
                                style={{ width: '40%' }} // Simulado, se podría calcular vs objetivo
                            />
                        </div>
                    </CardContent>
                </Card>
