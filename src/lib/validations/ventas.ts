...
export const GuardarBorradorSchema = z.object({
    ...
    plantilla_pdf_id: z.string().uuid().optional(),
    ...
    numero_manual: z.string().optional(),
    ...
    importe_retencion: z.number().optional(),
    subtotal: z.number(),
...
export const EditarFacturaSchema = z.object({
    ...
    notas: z.string().optional(),
    serie: z.string().uuid().optional(),
    plantilla_pdf_id: z.string().uuid().optional(),
    divisa: z.string().optional(),
    tipo_cambio: z.number().min(0).optional(),
    lineas: z.array(LineaFacturaSchema).optional(),
    descuento_tipo: z.enum(['porcentaje', 'fijo']).optional(),
    descuento_valor: z.number().min(0).optional(),
    recargo_equivalencia: z.boolean().optional(),
    recargo_porcentaje: z.number().min(0).optional(),
