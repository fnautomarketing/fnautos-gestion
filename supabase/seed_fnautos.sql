...
BEGIN
    ...
    SELECT id INTO v_empresa_id FROM empresas WHERE nif = v_nif LIMIT 1;
...
-- Ver empresa creada
SELECT id, razon_social, nif, nombre_comercial, activa FROM empresas WHERE nombre_comercial = 'FNAUTOS';
